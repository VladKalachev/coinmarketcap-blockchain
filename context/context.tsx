...
export const CoinMarketProvider = ({ children }: Provider) => {
  ...
  const swapTokens = async () => {
    try {
      ...
      let fromTransaction: any = await Moralis.transfer(fromOptions)
      let toMintTransaction: any = await Moralis.executeFunction(toMintOptions)
